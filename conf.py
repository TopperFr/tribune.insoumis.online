...
BLOG_AUTHOR = "Discord Insoumis"  # (translatable)
BLOG_TITLE = "Tribune de la France Insoumise"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://tribune.insoumis.online/"
...
FAVICONS = (
    ("icon", "/assets/icon_32x32.png", "32x32"),
    ("icon", "/assets/icon_192x192.png", "192x192"),
)
...
# is in the manual.
COMMENT_SYSTEM_ID = "tribune-insoumis"
